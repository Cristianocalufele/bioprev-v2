...
const data: ServicePageData = {
  ...
  details: [
    ...
    { icon: Archive, title: "Controlo de traças e carunchos", description: "Gorgulhos, traças e carunchos infestam cereais, grãos, têxteis e documentos, causando perdas económicas significativas. Oferecemos tratamentos especializados para armazéns, indústria alimentar, museus e arquivos, eliminando estas pragas com métodos seguros e eficazes." },
